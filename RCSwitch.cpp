...
void RCSwitch::enableTransmit(int nTransmitterPin) {
  ...
  this->chip = gpiod_chip_open_by_name(this->chipname);
  this->lineRed = gpiod_chip_get_line(this->chip, this->nTransmitterPin);
  gpiod_line_request_output(this->lineRed, "RCSwitch", 0);
}
...
void RCSwitch::digitalWrite(int value) {
  gpiod_line_set_value(this->lineRed, value);
}
